...
public class EntitiesViewHeaderIcon<E extends Entity> extends Icon {

    public static final String VIEW_HEADER_ICON_ID_SUFFIX = "-view-header-icon";

    public EntitiesViewHeaderIcon(String idPrefix, VaadinIcon vaadinIcon, EntitiesDataProvider<E> entitiesDataProvider) {
        super(vaadinIcon);
        setSize("60px");
