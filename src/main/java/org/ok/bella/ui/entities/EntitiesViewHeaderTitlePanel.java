...
public class EntitiesViewHeaderTitlePanel<E extends Entity> extends HorizontalLayout {
    ...
    public EntitiesViewHeaderTitlePanel(String idPrefix, String titleText, EntitiesDataProvider<E> entitiesDataProvider, VaadinIcon vaadinIcon) {
