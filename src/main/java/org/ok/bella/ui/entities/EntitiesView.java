...
public abstract class EntitiesView extends VerticalLayout {
    ...
    public EntitiesView(EntitiesDataProvider entitiesDataProvider) {
    ...
    protected abstract EntitiesViewBody getViewBody(EntitiesDataProvider entitiesDataProvider);
}
