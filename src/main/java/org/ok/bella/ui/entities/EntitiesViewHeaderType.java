...
public class EntitiesViewHeaderType<T extends EntitiesDataProvider> extends H2 {

    public static final String VIEW_HEADER_TYPE_ID_SUFFIX = "-view-header-type";

    public EntitiesViewHeaderType(String idPrefix, String titleText, T entitiesDataProvider) {
