...
public class EntitiesViewHeaderType<E extends Entity> extends H2 {

    public static final String VIEW_HEADER_TYPE_ID_SUFFIX = "-view-header-type";

    public EntitiesViewHeaderType(String idPrefix, String titleText, EntitiesDataProvider<E> entitiesDataProvider) {
